...
|---|---|---|---|
| v2.4.8 | 2026-05-27 | HST rows now appear per-invoice (one row per invoice with HST, showing invoice number) instead of one aggregated row per location. Type label changed to "HST Applied". | pending |
