...
|---|---|---|---|
| v2.5.1 | 2026-05-27 | Remove invoice # from HST Applied summary rows; fix PDF bundle page cutoff by normalizing CropBox=MediaBox on all copied pages (Sage PDFs have a smaller CropBox that some viewers clip to). | pending |
